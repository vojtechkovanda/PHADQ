...
function [SDRs, ODGs] = dequantization_main(audiofile, wordlength)
...
param.algorithm = 'CP_cons_l1_ana'; % algorithm to compute declipping, options: 
                                         % 'DR_cons_l1_syn', 
                                         % 'CP_cons_l1_ana', 
                                         % 'A_SPADQ', 
                                         % 'S_SPADQ', 
...
[~, ~, ODGs] = audioqual(data, data_rec, fs);
