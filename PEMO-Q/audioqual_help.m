% AUDIOQUAL    Estimation of perceived audio quality following the PEMO-Q method
%
%   USAGE:
%     [PSM, PSMt, ODG, PSM_inst] = audioqual(RefSig, TestSig, fs, [dt, modproc, MaxLag, PauseCut, LevelAlign, assim, verbose])
%
%   INPUT:
...
%                  (i.e. PSM_inst = PSM(t) with t = n*dt ms, n = 1,2,..., dt = 10 ms per default)
%
...
%
%   DESCRIPTION:
%     AUDIOQUAL is the implementation of the method for objective perceptual
%     assessment of audio quality "PEMO-Q" of Huber and Kollmeier (2006), slightly 
%     modified. It predicts the perceived audio quality of a given test signal
%     relative to that of a reference signal, using the  model of auditory perception
%     ("PEMO") by Dau et al. (1996, 1997).
